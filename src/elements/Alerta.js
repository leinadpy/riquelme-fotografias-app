...
const Alerta = ({ tipo, mensaje, estadoAlerta, setEstadoAlerta }) => {
  useEffect(() => {
    ...
    Lo que hacemos es limpiar el tiempo para que no intente cambiar el estado si el componente
    no está en pantalla. Es importante para poder cambiar de componentes en pantalla sin errores.
    */
